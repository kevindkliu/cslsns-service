...
public class RSAForPrivateCodec extends BasicCodec {
	...
	// rsa，签名算法可以是 md5withrsa 、 sha1withrsa 、 sha256withrsa 、 sha384withrsa 、
	// sha512withrsa
	...
	/*
	 * private PublicKey getRSAPublicKey() throws Exception { X509EncodedKeySpec
	 * x509EncodedKeySpec = new X509EncodedKeySpec(decoder(super.publicKey));
	 * KeyFactory keyFactory = KeyFactory.getInstance(ALGORITHM); return
